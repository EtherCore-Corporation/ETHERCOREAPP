...
export default async function Home() {
  const { hero, services, portfolio, testimonials, blogs, companyInfo } = await getData();
              ...
              {testimonials.map((testimonial) => (
                <div 
                  ...
                  className="group relative p-6 rounded-xl bg-gradient-to-br from-[#0d2231]/80 to-[#1a2438]/80 
                    backdrop-blur-sm border border-teal-500/10 hover:border-teal-500/30 
                    transition-all duration-500 hover:shadow-[0_0_30px_rgba(45,212,191,0.2)]"
                >
                  {/* Background Effect */}
                  <div className="absolute inset-0 bg-gradient-to-r from-teal-600/0 via-teal-600/5 to-blue-600/0 
                  ...
                  <div className="relative">
                    ...
                    {/* Client */}
                    <p className="text-teal-400 font-semibold group-hover:text-teal-300 transition-colors duration-300">
