              ...
              {testimonials.map((testimonial) => (
                ...
                >
                  ...
                  <div className="absolute top-3 sm:top-4 right-3 sm:right-4 opacity-20 group-hover:opacity-40 transition-opacity">
                    <svg className="w-6 h-6 sm:w-8 sm:h-8 text-teal-400" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-gradient-to-r from-teal-500 to-blue-500 
                    ...
                    <p className="font-semibold bg-gradient-to-r from-teal-400 to-blue-400 
                      bg-clip-text text-transparent group-hover:from-teal-300 group-hover:to-blue-300 text-center text-sm sm:text-base">
